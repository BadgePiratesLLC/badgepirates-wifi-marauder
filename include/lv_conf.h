...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    /* Nexus 84f4e52c: keep this in sync with THEME_LV_MEM_SIZE_BYTES in
       include/badge_ui_theme.h - that header is the named-constant source
       of truth for CC13's no-PSRAM budget, this file just has to agree
       with it because lv_conf.h is parsed before Arduino headers exist. */
...
#define LV_FONT_MONTSERRAT_12 1  // Nexus 84f4e52c: subtitles/hints, ~12px reads clean at this AA size on a 240px panel
#define LV_FONT_MONTSERRAT_14 1
#define LV_FONT_MONTSERRAT_16 0
#define LV_FONT_MONTSERRAT_18 0
#define LV_FONT_MONTSERRAT_20 1  // Nexus 176cc276: splash screen wordmark, the one screen where type IS the product
#define LV_FONT_MONTSERRAT_22 0
#define LV_FONT_MONTSERRAT_24 0
#define LV_FONT_MONTSERRAT_26 0
#define LV_FONT_MONTSERRAT_28 0  // unused on CC13 (no PSRAM); QACode_27/CC15 desk-console big-number displays only
...
#define LV_FONT_MONTSERRAT_48 0  // unused on CC13, see 28 above
...
#define LV_USE_THEME_DEFAULT 1
    ...
    // 1 since v2.1.4. The v2.1.3 dark theme repainted the SCREENS but left this
    // at light, so LVGL kept handing every unstyled label the light theme's dark
    // ink — black text on a near-black ground. Screens that never set a colour
    // explicitly are the majority, so this one line is most of the bug; the
    // hardcoded 0x000000 labels were the visible remainder.
